...
C.Duration_80000 = new P.Duration(80000);
...
function dart_precompiled($collectedClasses) {
  ...
  function Box(x, y, color, id, dragged, rightBuddy, leftBuddy, leftNeighbor, rightNeighbor, dragTimer) {
    this.x = x;
    this.y = y;
    this.color = color;
    this.id = id;
  ...
  function Game(canvas, ctx, width, height, myState, box, tmanager, tlayer, score, clientID, trialNum) {
    this.canvas = canvas;
    this.ctx = ctx;
    this.width = width;
    this.height = height;
